...
static THD_WORKING_AREA(serial_worker_wa, DEFAULT_STACK);
...
static THD_FUNCTION(serial_worker, arg)
{
        (void)arg;
        chRegSetThreadName("Serial worker");
        system_serial_worker();
}
...
int main(void)
{
        ...
        log_info("===RaceCapture/Pro CANx demo (Version %u.%u.%u)===\r\n", MAJOR_VER, MINOR_VER, PATCH_VER);
        ...
        chThdCreateStatic(serial_worker_wa, sizeof(serial_worker_wa), NORMALPRIO, serial_worker, NULL);
